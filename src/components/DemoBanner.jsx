...
export default function DemoBanner() {
  return (
    <div className="bg-[#0B1F33] text-slate-300 text-xs py-1.5 px-4 border-b border-[#12304A] flex flex-wrap items-center justify-between gap-2 select-none">
      <div className="flex items-center gap-2 font-mono text-[11px] tracking-wide text-slate-300">
        <span className="inline-flex items-center gap-1 text-teal-400 font-semibold uppercase">
